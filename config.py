...
# Reviewer3.com (AI Review)
REVIEWER3_API_URL = os.getenv("REVIEWER3_API_URL", "https://reviewer3.com")
REVIEWER3_API_KEY = os.getenv("REVIEWER3_API_KEY", "")
REVIEWER3_WEBHOOK_SECRET = os.getenv("REVIEWER3_WEBHOOK_SECRET", "")

# Anthropic (AI Screening)
